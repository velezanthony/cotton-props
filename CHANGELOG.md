...
- **715 automated tests** running in a real VS Code Extension Host.
...
The extension was feature-complete for months before it reached the Marketplace.
These are the defects found and fixed in that window. No published version ever
carried them, but they are recorded here because they shaped the code that ships
— most were silent: a wrong answer that looked like a right one.
