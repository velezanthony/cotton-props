...
- **715 tests automatizados** corriendo en un Extension Host real de VS Code.
...
La extensión estuvo terminada durante meses antes de llegar al Marketplace.
Estos son los defectos que aparecieron y se corrigieron en esa ventana. Ninguna
versión publicada los llevó, pero quedan aquí porque dieron forma al código que
se publica — casi todos eran silenciosos: una respuesta incorrecta con pinta de
correcta.
